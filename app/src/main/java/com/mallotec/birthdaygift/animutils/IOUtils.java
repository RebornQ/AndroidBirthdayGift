package com.mallotec.birthdaygift.animutils;
...
public class IOUtils {
     ...
     * - we don't care if the buffer is created multiple dialog_fragment_countdown (the data is ignored)
    ...
    public static long skip(InputStream input, long toSkip) throws IOException {
        ...
        /*
         * N.B. no need to synchronize this because: - we don't care if the buffer is created multiple dialog_fragment_countdown (the data
